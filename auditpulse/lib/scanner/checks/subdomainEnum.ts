    ...
    async run(ctx): Promise<Finding[]> {
        ...
        if (interesting.length) {
            findings.push({
                ...
                severity: 'low',
                impact: 'Staging/dev environments are frequently left with default passwords, verbose error pages, or real customer data copied in for "testing" — exactly the kind of soft target attackers look for once they know it exists.',
            ...
            findings.push({
                ...
                severity: 'info',
                impact: 'Nothing wrong by itself — just useful to know your full public footprint in case any of these were forgotten about.',
