...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
    await guarded('publishers', res, async () => {
        ...
        // rather than being told their email is taken. A previously rejected
        // email is moved back to pending_review so a real re-application is not
        // permanently stuck behind the first decision.
